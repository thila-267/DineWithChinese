<?php # Script 18.10 - forgot_password.
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	require ('C:\wamp64\www\assignment_two\mysqli_connect.php');
	// Assume nothing:
	$uid = FALSE;
	...
	if ($uid) { // If everything's OK.
		...
		if (mysqli_affected_rows($dbc) == 1) { // If it ran OK.
			// Send an email:
			$body = "Your password to log in has been temporarily changed to '$p'. Please log in using this password and this email address. Then you may change your password to something more familiar.";
			
			mail ($_POST['email'], 'Your temporary password.', $body, 'From: thila267@gmail.com');
